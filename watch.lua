--This Code is written by kilbith (https://forum.minetest.net/viewtopic.php?t=13718)
...
minetest.register_chatcommand("watch_id", {
	params = "<to_name>",
	description = "watch a given player",
	privs = {watch=true},
	func = function(name, param)
		local watcher = minetest.get_player_by_name(name)
		local target = minetest.get_player_by_name(playerid[tonumber(param)])
		local privs = minetest.get_player_privs(name)
...
minetest.register_chatcommand("unwatch_id", {
